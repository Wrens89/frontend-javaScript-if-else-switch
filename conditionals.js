...
// ==========================================
const bigNumbers = 10 >= 20;
console.log("Is 10 groter dan 20? " + bigNumbers);
...
// ==========================================
const different = 10 != 11;
console.log("Is 10 ongelijk aan 11? " + different);

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const juice = "sweet" == "sappig";
console.log("Zijn zoet en sappig hetzelfde? " + juice);
